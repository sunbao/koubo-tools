...
public class HotspotService {
    ...
    public List<Hotspot> fetchHotspotsFromExternalAPI() {
        try {
            ...
            hotspot1.setType("科技");
            hotspot1.setTags(Arrays.asList("AI", "科技", "未来"));
            
            Hotspot hotspot2 = new Hotspot("夏日美食推荐", "炎炎夏日，来点清爽美食", "快手", 88.2);
            hotspot2.setType("美食");
            hotspot2.setTags(Arrays.asList("美食", "夏日", "清爽"));
            
            Hotspot hotspot3 = new Hotspot("旅行攻略分享", "国内热门旅游景点推荐", "抖音", 92.1);
            hotspot3.setType("旅游");
            hotspot3.setTags(Arrays.asList("旅行", "攻略", "景点"));
            
            return Arrays.asList(hotspot1, hotspot2, hotspot3);
        } catch (Exception e) {
            // 记录日志
